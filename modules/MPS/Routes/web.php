...
Route::prefix($route)->group(function () {
    ...
    Route::prefix('app')->group(function () {
        ...
        Route::middleware('auth')->group(function () {
            ...
            // Report routes
            Route::get('reports/time_clocks', 'TimeClockController@index');
            Route::get('reports/registers', 'RegisterRecordController@index');
            ...
            Route::middleware('role:super')->group(function () {
                ...
                // List routes
                Route::get('logs', 'UtilityController@logs');
                Route::get('logs/{activity}', 'UtilityController@showLog');
            ...
            Route::prefix('reports')->namespace('Reports')->group(function () {
                Route::get('totals', 'ReportController@index')->name('totals');
                Route::get('items/top', 'ItemReportController@top')->name('items.top');
                ...
                Route::get('adjustments', 'StockAdjustmentReportController@index')->name('adjustments.report');
                ...
                Route::get('adjustments/table', 'StockAdjustmentReportController@table')->name('adjustments.report.table');
