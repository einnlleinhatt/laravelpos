...
class Location extends Base
{
    ...
    public static $searchable = ['id', 'phone', 'color', 'header', 'footer', 'address', 'name', 'email', 'account.name', 'logo', 'timezone', 'extra_attributes'];

    protected $casts = ['extra_attributes' => 'array'];

    protected $fillable = ['phone', 'color', 'header', 'footer', 'address', 'name', 'email', 'account_id', 'logo', 'timezone', 'extra_attributes'];
